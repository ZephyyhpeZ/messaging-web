...
import FriendSection from "./[id]/(components)/friendsSection";
import { SendFriendRequest } from "./[id]/sendFriendRequest";
import {
  Carousel,
  CarouselContent,
  CarouselItem,
...
export default function RightSideFriendsOnly() {
  ...
  return (
    <Tabs defaultValue="friends" className="flex h-[94vh] w-[250px] flex-col">
      <TabsList className="w-full bg-card-foreground">
        <TabsTrigger
          value="friends"
          className="w-full data-[state=active]:bg-slate-800 data-[state=active]:text-slate-400"
        >
          Friends
        </TabsTrigger>
      </TabsList>
